...
import { ThreadDataInterface, IThreadsDto } from '@core'
import { MongoDBClient } from '@infra'
import { DATABASE_CONSTANTS } from '../common/constants.js'
import { logger } from '@shared'

export default class ThreadDataAdapter implements ThreadDataInterface {
  ...
  async create(document: IThreadsDto): Promise<unknown> {
    try {
